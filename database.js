...
const db = {
    cpu: [
        dummyItem,
        // AM5
        { id: 'c_9950x', name: 'AMD Ryzen 9 9950X', price: 650, score: 24000, socket: 'AM5' },
        { id: 'c_9900x', name: 'AMD Ryzen 9 9900X', price: 499, score: 20000, socket: 'AM5' },
        { id: 'c_9800x3d', name: 'AMD Ryzen 7 9800X3D', price: 440, score: 17000, socket: 'AM5' },
        { id: 'c_9700x', name: 'AMD Ryzen 7 9700X', price: 359, score: 14500, socket: 'AM5' },
        { id: 'c_9600x', name: 'AMD Ryzen 5 9600X', price: 279, score: 12000, socket: 'AM5' },
        { id: 'c_7950x3d', name: 'AMD Ryzen 9 7950X3D', price: 600, score: 23500, socket: 'AM5' },
        { id: 'c_7950x', name: 'AMD Ryzen 9 7950X', price: 550, score: 22000, socket: 'AM5' },
        { id: 'c_7900x', name: 'AMD Ryzen 9 7900X', price: 420, score: 19000, socket: 'AM5' },
        { id: 'c_7800x3d', name: 'AMD Ryzen 7 7800X3D', price: 350, score: 13500, socket: 'AM5' },
        { id: 'c_7700x', name: 'AMD Ryzen 7 7700X', price: 290, score: 12500, socket: 'AM5' },
        { id: 'c_7600x', name: 'AMD Ryzen 5 7600X', price: 200, score: 10500, socket: 'AM5' },
        { id: 'c_7600', name: 'AMD Ryzen 5 7600', price: 180, score: 10000, socket: 'AM5' },
        // AM4
        { id: 'c_5950x', name: 'AMD Ryzen 9 5950X', price: 400, score: 16000, socket: 'AM4' },
        { id: 'c_5900x', name: 'AMD Ryzen 9 5900X', price: 300, score: 13500, socket: 'AM4' },
        { id: 'c_5800x3d', name: 'AMD Ryzen 7 5800X3D', price: 300, score: 11000, socket: 'AM4' },
        { id: 'c_5800x', name: 'AMD Ryzen 7 5800X', price: 200, score: 10500, socket: 'AM4' },
        { id: 'c_5700x', name: 'AMD Ryzen 7 5700X', price: 170, score: 9500, socket: 'AM4' },
        { id: 'c_5600x', name: 'AMD Ryzen 5 5600X', price: 130, score: 8500, socket: 'AM4' },
        { id: 'c_5600', name: 'AMD Ryzen 5 5600', price: 115, score: 8200, socket: 'AM4' },
        { id: 'c_5600g', name: 'AMD Ryzen 5 5600G', price: 110, score: 7500, socket: 'AM4' },
        { id: 'c_5500', name: 'AMD Ryzen 5 5500', price: 90, score: 7000, socket: 'AM4' },
        { id: 'c_4500', name: 'AMD Ryzen 5 4500', price: 75, score: 6000, socket: 'AM4' },
        { id: 'c_3900x', name: 'AMD Ryzen 9 3900X', price: 250, score: 11500, socket: 'AM4' },
        ...
        { id: 'c_14600k', name: 'Intel Core i5-14600K', price: 300, score: 15000, socket: 'LGA1700' },
        { id: 'c_13900k', name: 'Intel Core i9-13900K', price: 500, score: 20000, socket: 'LGA1700' },
        { id: 'c_13700k', name: 'Intel Core i7-13700K', price: 360, score: 18500, socket: 'LGA1700' },
        { id: 'c_13600k', name: 'Intel Core i5-13600K', price: 280, score: 14000, socket: 'LGA1700' },
        { id: 'c_13400f', name: 'Intel Core i5-13400F', price: 180, score: 11000, socket: 'LGA1700' },
        { id: 'c_13100f', name: 'Intel Core i3-13100F', price: 110, score: 7500, socket: 'LGA1700' },
        { id: 'c_12900k', name: 'Intel Core i9-12900K', price: 350, score: 17000, socket: 'LGA1700' },
        { id: 'c_12700k', name: 'Intel Core i7-12700K', price: 250, score: 14500, socket: 'LGA1700' },
        { id: 'c_12600k', name: 'Intel Core i5-12600K', price: 180, score: 12000, socket: 'LGA1700' },
        { id: 'c_12400f', name: 'Intel Core i5-12400F', price: 140, score: 9500, socket: 'LGA1700' },
        { id: 'c_12100f', name: 'Intel Core i3-12100F', price: 90, score: 6500, socket: 'LGA1700' },
        // LGA1200 (Intel 10th/11th Gen)
        { id: 'c_11900k', name: 'Intel Core i9-11900K', price: 280, score: 12500, socket: 'LGA1200' },
        { id: 'c_11700k', name: 'Intel Core i7-11700K', price: 200, score: 10500, socket: 'LGA1200' },
        { id: 'c_11600k', name: 'Intel Core i5-11600K', price: 160, score: 8500, socket: 'LGA1200' },
        { id: 'c_11400f', name: 'Intel Core i5-11400F', price: 120, score: 7500, socket: 'LGA1200' },
        { id: 'c_10900k', name: 'Intel Core i9-10900K', price: 250, score: 11500, socket: 'LGA1200' },
        { id: 'c_10700k', name: 'Intel Core i7-10700K', price: 180, score: 9500, socket: 'LGA1200' },
        { id: 'c_10400f', name: 'Intel Core i5-10400F', price: 100, score: 6500, socket: 'LGA1200' },
        { id: 'c_10100f', name: 'Intel Core i3-10100F', price: 70, score: 4500, socket: 'LGA1200' }
    ],
    gpu: [
        dummyItem,
        // RTX 50 series
        ...
        { id: 'g_5070ti', name: 'NVIDIA RTX 5070 Ti 16GB', price: 899, score: 24500 },
        { id: 'g_5070', name: 'NVIDIA RTX 5070 12GB', price: 599, score: 20500 },
        // RTX 40 series
        { id: 'g_4090', name: 'NVIDIA RTX 4090 24GB', price: 1799, score: 36000 },
        { id: 'g_4080s', name: 'NVIDIA RTX 4080 Super', price: 999, score: 28000 },
        { id: 'g_4080', name: 'NVIDIA RTX 4080 16GB', price: 1100, score: 27000 },
        { id: 'g_4070tis', name: 'NVIDIA RTX 4070 Ti Super', price: 799, score: 24000 },
        { id: 'g_4070ti', name: 'NVIDIA RTX 4070 Ti 12GB', price: 750, score: 22500 },
        { id: 'g_4070s', name: 'NVIDIA RTX 4070 Super', price: 599, score: 21000 },
        { id: 'g_4070', name: 'NVIDIA RTX 4070 12GB', price: 549, score: 18000 },
        { id: 'g_4060ti16', name: 'NVIDIA RTX 4060 Ti 16GB', price: 449, score: 13500 },
        { id: 'g_4060ti8', name: 'NVIDIA RTX 4060 Ti 8GB', price: 399, score: 13000 },
        { id: 'g_4060', name: 'NVIDIA RTX 4060 8GB', price: 299, score: 10500 },
        // RTX 30 series
        { id: 'g_3090ti', name: 'NVIDIA RTX 3090 Ti 24GB', price: 1200, score: 22000 },
        { id: 'g_3090', name: 'NVIDIA RTX 3090 24GB', price: 900, score: 20000 },
        { id: 'g_3080ti', name: 'NVIDIA RTX 3080 Ti 12GB', price: 700, score: 19500 },
        { id: 'g_3080_12', name: 'NVIDIA RTX 3080 12GB', price: 550, score: 18500 },
        { id: 'g_3080', name: 'NVIDIA RTX 3080 10GB', price: 450, score: 18000 },
        { id: 'g_3070ti', name: 'NVIDIA RTX 3070 Ti 8GB', price: 400, score: 15000 },
        { id: 'g_3070', name: 'NVIDIA RTX 3070 8GB', price: 350, score: 14000 },
        { id: 'g_3060ti', name: 'NVIDIA RTX 3060 Ti 8GB', price: 300, score: 12000 },
        { id: 'g_3060_12', name: 'NVIDIA RTX 3060 12GB', price: 250, score: 8700 },
        { id: 'g_3060_8', name: 'NVIDIA RTX 3060 8GB', price: 230, score: 7800 },
        { id: 'g_3050', name: 'NVIDIA RTX 3050 8GB', price: 180, score: 6000 },
        // RTX 20 & GTX 16/10 series
        { id: 'g_2080ti', name: 'NVIDIA RTX 2080 Ti 11GB', price: 350, score: 14500 },
        { id: 'g_2080s', name: 'NVIDIA RTX 2080 Super', price: 250, score: 11500 },
        { id: 'g_2070s', name: 'NVIDIA RTX 2070 Super', price: 200, score: 10000 },
        { id: 'g_2060s', name: 'NVIDIA RTX 2060 Super', price: 160, score: 8500 },
        { id: 'g_2060', name: 'NVIDIA RTX 2060 6GB', price: 140, score: 7500 },
        { id: 'g_1660s', name: 'NVIDIA GTX 1660 Super', price: 120, score: 6000 },
        { id: 'g_1650s', name: 'NVIDIA GTX 1650 Super', price: 100, score: 4500 },
        { id: 'g_1080ti', name: 'NVIDIA GTX 1080 Ti 11GB', price: 150, score: 9500 },
        { id: 'g_1080', name: 'NVIDIA GTX 1080 8GB', price: 110, score: 7200 },
        { id: 'g_1070', name: 'NVIDIA GTX 1070 8GB', price: 80, score: 5500 },
        { id: 'g_1060_6', name: 'NVIDIA GTX 1060 6GB', price: 60, score: 4000 },
        // AMD RX 7000
        { id: 'g_7900xtx', name: 'AMD Radeon RX 7900 XTX', price: 899, score: 29000 },
        { id: 'g_7900xt', name: 'AMD Radeon RX 7900 XT', price: 699, score: 25000 },
        { id: 'g_7900gre', name: 'AMD Radeon RX 7900 GRE', price: 549, score: 21500 },
        { id: 'g_7800xt', name: 'AMD Radeon RX 7800 XT', price: 499, score: 19000 },
        { id: 'g_7700xt', name: 'AMD Radeon RX 7700 XT', price: 419, score: 16500 },
        { id: 'g_7600xt', name: 'AMD Radeon RX 7600 XT', price: 329, score: 11500 },
        { id: 'g_7600', name: 'AMD Radeon RX 7600', price: 259, score: 10500 },
        // AMD RX 6000
        { id: 'g_6950xt', name: 'AMD Radeon RX 6950 XT', price: 550, score: 21000 },
        { id: 'g_6900xt', name: 'AMD Radeon RX 6900 XT', price: 500, score: 19500 },
        { id: 'g_6800xt', name: 'AMD Radeon RX 6800 XT', price: 400, score: 18500 },
        { id: 'g_6800', name: 'AMD Radeon RX 6800', price: 350, score: 16000 },
        { id: 'g_6750xt', name: 'AMD Radeon RX 6750 XT', price: 330, score: 13500 },
        { id: 'g_6700xt', name: 'AMD Radeon RX 6700 XT', price: 300, score: 12500 },
        { id: 'g_6650xt', name: 'AMD Radeon RX 6650 XT', price: 230, score: 10000 },
        { id: 'g_6600xt', name: 'AMD Radeon RX 6600 XT', price: 210, score: 9500 },
        { id: 'g_6600', name: 'AMD Radeon RX 6600', price: 180, score: 8000 },
        { id: 'g_6500xt', name: 'AMD Radeon RX 6500 XT', price: 130, score: 5000 },
        // AMD RX 5000
        { id: 'g_5700xt', name: 'AMD Radeon RX 5700 XT', price: 150, score: 9000 },
        { id: 'g_5700', name: 'AMD Radeon RX 5700', price: 130, score: 8000 },
        { id: 'g_5600xt', name: 'AMD Radeon RX 5600 XT', price: 110, score: 7000 },
        { id: 'g_580', name: 'AMD Radeon RX 580 8GB', price: 60, score: 4200 }
    ],
    mobo: [
        dummyItem,
        // AM5 (DDR5)
